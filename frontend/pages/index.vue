...
<template>
  <div>
    ...
    <!-- 固定搜索条（sticky，始终可见） -->
    <div class="sticky top-0 z-20 border-b border-slate-200 bg-white/95 backdrop-blur-sm dark:border-slate-800 dark:bg-slate-950/95">
      <div class="max-w-5xl mx-auto px-4 sm:px-6 py-2.5">
        <div class="relative">
          ...
          <input
            ...
            class="w-full pl-9 pr-9 py-2 text-sm rounded-lg border border-slate-200 bg-white text-slate-700 placeholder-slate-400 outline-none focus:border-slate-400 focus:ring-2 focus:ring-slate-200 transition dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:placeholder-slate-500 dark:focus:border-slate-500 dark:focus:ring-slate-700"
          />
          <button
            v-if="searchQuery"
