        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="relative mb-4">
            ...
            <input
              ...
              type="search"
              placeholder="搜索文章…"
              class="w-full pl-9 pr-8 py-2 text-sm rounded-lg border border-slate-200 bg-white text-slate-700 placeholder-slate-400 outline-none focus:border-slate-400 focus:ring-1 focus:ring-slate-200 transition dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:placeholder-slate-500 dark:focus:border-slate-500"
            />
            <button
              v-if="searchQuery"
